# AcademiaX Frontend Base — TailAdmin React (JavaScript)

This copy has been converted from the TailAdmin React TypeScript template to **React + JavaScript + Vite**.
...
The template is intentionally kept as a UI base. AcademiaX business pages and API integration should be added separately.

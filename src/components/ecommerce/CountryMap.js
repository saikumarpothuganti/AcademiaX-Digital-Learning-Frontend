...
export default function CountryMap() {
    return (_jsx(VectorMap, { map: "world", backgroundColor: "transparent", markerStyle: {
            initial: {
                fill: "#465FFF",
                r: 4,
            },
        ...
        ], zoomButtons: false, zoomOnScroll: false, zoomMax: 12, zoomMin: 1, zoomAnimate: true, zoomStep: 1.5, regionStyle: {
            initial: {
                fill: "#D0D5DD",
                fillOpacity: 1,
                fontFamily: "Outfit",
